...
import 'attendance_stud.dart';

class DashboardStud extends StatefulWidget {
  const DashboardStud({Key? key}) : super(key: key);

  @override
  State<DashboardStud> createState() => _DashboardStudState();
}

class _DashboardStudState extends State<DashboardStud> {
  @override
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => AttendanceStud(
